...
const Mensajes = () => {
        ...
        return (
            ...
            <View style={styles.boxComment}>
                ...
                <View style={styles.boxComments}>
                    <TextInput style={styles.boxCommentsIn}
    ...
    const getComment = async ( folio : any, idMaquina : any ) => {
        await axios.get('http://192.168.0.46:4100/comments/' + `${folio}/${idMaquina}` ).then(function(response) {
    ...
    const agregarComentario = async () => {
        ...
        const response = await axios.put(
            'http://192.168.0.46:4100/comments/', {
        ...
        <View style={styles.contForms}>
            ...
            <View style={styles.contFormTitle}>
                <View style={styles.contFormbtnIzq}>
                    <Button onPress={() => navigation.navigate("Head")}
            ...
            <View style={styles.boxCommentInput}>
                <TextInput style={styles.txtComment} 
